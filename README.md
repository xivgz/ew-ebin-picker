...
Alts and golems I keep in because it's too bothersome to sort out. I will try to limit it per subrace at least.\
One-off golems like glamourer changing shouldn't be included however.\
If there is actually the same character, same eye color, same face shapes, same everything, do let me know.\
\
